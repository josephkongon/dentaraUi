...
import {
  ...
  useStyleConfig,
  useTheme
} from "./chunk-EH3MHSSG.js";
import "./chunk-N4EVRX3W.js";
import "./chunk-AKFFJPAU.js";
import "./chunk-NT5FMHKT.js";
import "./chunk-PS4FJBL3.js";
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react3.useMemo)(
    () => shouldWrapChildren ? import_react3.Children.map(children, (child, index) => (0, import_jsx_runtime8.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react4.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      return (0, import_jsx_runtime11.jsxs)(import_react4.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(import_jsx_runtime17.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime17.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime17.jsx)(import_react5.Fragment, { children: chunk.text }, index);
  }) });
}
